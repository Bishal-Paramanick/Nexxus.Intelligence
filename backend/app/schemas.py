...
# (Consumer: Frontend Visualizer | Provider: Neo4j Driver & Graph Queries)
# =============================================================================
...
# =============================================================================
# 2. ARNISH'S CONTRACT: GRAPH ANALYTICS & RISK SCORING ENGINE
# Role: Person 3 (Graph Analytics, Centrality & Risk Scoring Engine)
# Models consumed/generated by Arnish's `risk_engine.py`, `analytics.py`,
# and `schema_mapper.py` to deliver entity risk breakdown and network metrics.
# =============================================================================


class RiskBreakdown(BaseModel):
    """
    Arnish's Metric Breakdown:
    Provides sub-scores across centrality algorithms, call frequency patterns,
    ...
    # Granular Graph Data Science (GDS) centrality metrics calculated by Arnish
...
class EntityDetailResponse(BaseModel):
    """
    Arnish's Output Contract for Entity Deep Dive:
    Returned when querying detailed risk intelligence, tags, and metrics for a node.
    """
...
# =============================================================================
# 4. INGESTION SCHEMAS (Person 1 Extraction -> Entity Resolution -> Neo4j)
# =============================================================================
