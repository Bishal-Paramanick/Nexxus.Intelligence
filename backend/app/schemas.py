...
class EdgeProperties(BaseModel):
    ...
    amount: float | None = Field(default=None, description="Transaction amount in INR")
...
# =============================================================================
# 2. GRAPH ANALYTICS & RISK SCORING ENGINE SCHEMAS
# =============================================================================


class RiskBreakdown(BaseModel):
    """
    Sub-scores across graph centrality algorithms, call frequency patterns,
    cross-case linkage, and financial anomalies.
    """
...
class EntityDetailResponse(BaseModel):
    """
    Detailed entity-level risk intelligence and metrics response.
    """
    ...
    tags: list[str] = Field(
        ...
        description="Assigned role tags, e.g. ['Kingpin', 'Money Mule', 'Bridge Node']",
    )
...
# =============================================================================
# 3. LEGAL EVIDENCE SCHEMA (Section 65B Compliance)
# =============================================================================
